...
class TokyoPalette : PolkadotColorsPalette() {
    ...
    override val bg = Bg(
        ...
        illustration = Bg.Illustration(
            dark = PolkadotColorsPrimitives.AdvancedRubyRuby600,
            darkMuted = PolkadotColorsPrimitives.AdvancedRubyRuby300,
            light = PolkadotColorsPrimitives.AdvancedRubyRuby50,
        ...
        surface = Bg.Surface(
            container = PolkadotColorsPrimitives.AdvancedRubyRuby20,
            containerInverted = PolkadotColorsPrimitives.AdvancedRubyRuby700,
            main = PolkadotColorsPrimitives.AdvancedRubyRuby100,
            nested = PolkadotColorsPrimitives.AdvancedRubyRuby100,
            nestedInverted = PolkadotColorsPrimitives.AdvancedRubyRuby500,
            overlay = PolkadotColorsPrimitives.AlphaBlackBlackAlpha48
        )
    )
    override val fg = Fg(
        disabled = PolkadotColorsPrimitives.AdvancedRubyRuby300,
        error = PolkadotColorsPrimitives.RedRed600,
        ...
        secondaryInverted = PolkadotColorsPrimitives.AdvancedRubyRuby50,
        secondaryInvertedHover = PolkadotColorsPrimitives.NeutralNeutral150,
        staticWhite = PolkadotColorsPrimitives.NeutralWhite,
        success = PolkadotColorsPrimitives.GreenGreen600,
        tertiary = PolkadotColorsPrimitives.AdvancedRubyRuby600,
        tertiaryInverted = PolkadotColorsPrimitives.AdvancedRubyRuby100,
    ...
    override val stroke = Stroke(
        ...
        error = PolkadotColorsPrimitives.RedRed600,
        primary = PolkadotColorsPrimitives.AdvancedRubyRuby200,
        primaryInverted = PolkadotColorsPrimitives.ZincZinc800,
        secondary = PolkadotColorsPrimitives.AdvancedRubyRuby300,
        success = PolkadotColorsPrimitives.GreenGreen500,
        tertiary = PolkadotColorsPrimitives.AdvancedRubyRuby400,
        warning = PolkadotColorsPrimitives.AmberAmber500
    )
}
